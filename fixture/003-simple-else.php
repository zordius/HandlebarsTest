...
This is true! won $',$cx['funcs']['encq'](((is_array($in) && isset($in['value'])) ? $in['value'] : null), $cx),'!!
';}),'
';if ($cx['funcs']['isec'](((is_array($in) && isset($in['test'])) ? $in['test'] : null))){echo '
No, this is fake! not win $',$cx['funcs']['encq'](((is_array($in) && isset($in['value'])) ? $in['value'] : null), $cx),'!!
';}else{echo '';}echo '
';return ob_get_clean();
}
?>