...
We have $',$cx['funcs']['encq'](((is_array($in['award']['first']) && isset($in['award']['first']['value'])) ? $in['award']['first']['value'] : null), $cx),' for ',$cx['funcs']['encq'](((is_array($in['award']['first']) && isset($in['award']['first']['name'])) ? $in['award']['first']['name'] : null), $cx),' award!!
Raw dot test: ',$cx['funcs']['encq'](((is_array($in['winner']) && isset($in['winner']['name'])) ? $in['winner']['name'] : null), $cx),' ',$cx['funcs']['raw'](((is_array($in['award']['first']) && isset($in['award']['first']['value'])) ? $in['award']['first']['value'] : null), $cx),' for ',$cx['funcs']['raw'](((is_array($in['award']['first']) && isset($in['award']['first']['name'])) ? $in['award']['first']['name'] : null), $cx),'
';return ob_get_clean();
}
?>