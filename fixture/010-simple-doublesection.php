...
'funcs' => Array(
    ...
    ob_start();echo 'Hello ',$cx['funcs']['encq'](((is_array($in['winner']) && isset($in['winner']['name'])) ? $in['winner']['name'] : null), $cx),', you have just won $',$cx['funcs']['encq'](((is_array($in['winner']) && isset($in['winner']['value'])) ? $in['winner']['value'] : null), $cx),'!
',$cx['funcs']['sec'](((is_array($in) && isset($in['test'])) ? $in['test'] : null), $cx, $in, false, function($cx, $in) {echo '
Line 1
';}),'
This is a test, test = ',$cx['funcs']['encq'](((is_array($in) && isset($in['test'])) ? $in['test'] : null), $cx),'
',$cx['funcs']['sec'](((is_array($in) && isset($in['test'])) ? $in['test'] : null), $cx, $in, false, function($cx, $in) {echo '
Line 2
';}),'
';if ($cx['funcs']['isec'](((is_array($in) && isset($in['test'])) ? $in['test'] : null))){echo '
Line 3
';}else{echo '';}echo '
';if ($cx['funcs']['isec'](((is_array($in) && isset($in['test'])) ? $in['test'] : null))){echo '
Line 4
...
';}else{echo '';}echo '
---- double section ----
',$cx['funcs']['sec'](((is_array($in) && isset($in['sec'])) ? $in['sec'] : null), $cx, $in, false, function($cx, $in) {echo '
',$cx['funcs']['encq'](((is_array($in) && isset($in['name'])) ? $in['name'] : null), $cx),':',$cx['funcs']['encq'](((is_array($in) && isset($in['value'])) ? $in['value'] : null), $cx),'
',$cx['funcs']['sec'](((is_array($in) && isset($in['sec'])) ? $in['sec'] : null), $cx, $in, false, function($cx, $in) {echo '-- ',$cx['funcs']['encq'](((is_array($in) && isset($in['name'])) ? $in['name'] : null), $cx),', ',$cx['funcs']['encq'](((is_array($in) && isset($in['value'])) ? $in['value'] : null), $cx),'--';}),'
';}),' 
';return ob_get_clean();
}
?>