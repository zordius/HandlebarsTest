...
'funcs' => Array(
    ...
    ob_start();echo 'Hello ',$cx['funcs']['enc']('winner.name', $cx, $in),', you have just won $',$cx['funcs']['enc']('winner.value', $cx, $in),'!
',$cx['funcs']['sec']('test', $cx, $in, false, function($cx, $in) {echo '
Line 1
';}),'
...
Line 2
';}),'
';if ($cx['funcs']['isec']('test', $cx, $in)){echo '
Line 3
';}else{echo '';}echo '
';if ($cx['funcs']['isec']('test', $cx, $in)){echo '
Line 4
...
';}else{echo '';}echo '
---- double section ----
',$cx['funcs']['sec']('sec', $cx, $in, false, function($cx, $in) {echo '
',$cx['funcs']['enc']('name', $cx, $in),':',$cx['funcs']['enc']('value', $cx, $in),'
',$cx['funcs']['sec']('sec', $cx, $in, false, function($cx, $in) {echo '-- ',$cx['funcs']['enc']('name', $cx, $in),', ',$cx['funcs']['enc']('value', $cx, $in),'--';}),'
';}),' 
';return ob_get_clean();
}
?>