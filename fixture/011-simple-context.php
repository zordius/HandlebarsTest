...
'funcs' => Array(
    ...
    ob_start();echo '',$cx['funcs']['encq'](((is_array($in) && isset($in['grand_parent_id'])) ? $in['grand_parent_id'] : null), $cx),'
',$cx['funcs']['sec'](((is_array($in) && isset($in['parent_contexts'])) ? $in['parent_contexts'] : null), $cx, $in, false, function($cx, $in) {echo '
  ',$cx['funcs']['encq'](((is_array($in) && isset($in['parent_id'])) ? $in['parent_id'] : null), $cx),' (',$cx['funcs']['encq'](((is_array($in) && isset($in['grand_parent_id'])) ? $in['grand_parent_id'] : null), $cx),')
  ',$cx['funcs']['sec'](((is_array($in) && isset($in['child_contexts'])) ? $in['child_contexts'] : null), $cx, $in, false, function($cx, $in) {echo '
    ',$cx['funcs']['encq'](((is_array($in) && isset($in['child_id'])) ? $in['child_id'] : null), $cx),' (',$cx['funcs']['encq'](((is_array($in) && isset($in['parent_id'])) ? $in['parent_id'] : null), $cx),' << ',$cx['funcs']['encq'](((is_array($in) && isset($in['grand_parent_id'])) ? $in['grand_parent_id'] : null), $cx),')
  ';}),'
';}),'
';return ob_get_clean();
}
