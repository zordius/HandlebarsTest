...
'funcs' => Array(
    ...
    ob_start();echo '',$cx['funcs']['enc']('grand_parent_id', $cx, $in),'
',$cx['funcs']['sec']('parent_contexts', $cx, $in, false, function($cx, $in) {echo '
  ',$cx['funcs']['enc']('parent_id', $cx, $in),' (',$cx['funcs']['enc']('grand_parent_id', $cx, $in),')
  ',$cx['funcs']['sec']('child_contexts', $cx, $in, false, function($cx, $in) {echo '
