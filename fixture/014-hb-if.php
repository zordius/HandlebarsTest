...
Yes! ',$cx['funcs']['encq'](((is_array($in) && isset($in['name'])) ? $in['name'] : null), $cx),' is ',$cx['funcs']['encq'](((is_array($in) && isset($in['gender'])) ? $in['gender'] : null), $cx),'
';}else{echo '';}echo '
';if ($cx['funcs']['ifvar'](((is_array($in) && isset($in['test'])) ? $in['test'] : null))){echo '
2nd If, ',$cx['funcs']['encq'](((is_array($in) && isset($in['name'])) ? $in['name'] : null), $cx),' is ',$cx['funcs']['raw'](((is_array($in) && isset($in['gender'])) ? $in['gender'] : null), $cx),'
';}else{echo '
Else test, ',$cx['funcs']['encq'](((is_array($in) && isset($in['name'])) ? $in['name'] : null), $cx),' is ',$cx['funcs']['encq'](((is_array($in) && isset($in['gender'])) ? $in['gender'] : null), $cx),'
';}echo '
-TEST PATH-
';if ($cx['funcs']['ifvar'](((is_array($in['test']) && isset($in['test']['name'])) ? $in['test']['name'] : null))){echo '
Yes! ',$cx['funcs']['encq'](((is_array($in) && isset($in['subname'])) ? $in['subname'] : null), $cx),'
';}else{echo '
No! ',$cx['funcs']['encq'](((is_array($in) && isset($in['subname'])) ? $in['subname'] : null), $cx),'
';}echo '
