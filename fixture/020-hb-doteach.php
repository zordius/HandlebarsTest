...
<ul>
',$cx['funcs']['sec'](((is_array($in['people']) && isset($in['people']['boss'])) ? $in['people']['boss'] : null), $cx, $in, true, function($cx, $in) {echo '
 <li>',$cx['funcs']['encq'](((is_array($in) && isset($in['name'])) ? $in['name'] : null), $cx),' is a ',$cx['funcs']['encq'](((is_array($in) && isset($in['gender'])) ? $in['gender'] : null), $cx),' (',$cx['funcs']['encq'](((is_array($in) && isset($in['name'])) ? $in['name'] : null), $cx),', ',$cx['funcs']['encq'](((is_array($in) && isset($in['value'])) ? $in['value'] : null), $cx),', ',$cx['funcs']['encq'](((is_array($in) && isset($in['end'])) ? $in['end'] : null), $cx),')</li>
';}),'
</ul>
',$cx['funcs']['encq'](((is_array($in) && isset($in['end'])) ? $in['end'] : null), $cx),'
',$cx['funcs']['sec'](((is_array($in['people']) && isset($in['people']['boss'])) ? $in['people']['boss'] : null), $cx, $in, false, function($cx, $in) {echo '
 ...
 PARENT: ',$cx['funcs']['raw'](((is_array($in) && isset($in['name'])) ? $in['name'] : null), $cx),', ',$cx['funcs']['raw'](((is_array($in) && isset($in['value'])) ? $in['value'] : null), $cx),', ',$cx['funcs']['raw'](((is_array($in) && isset($in['end'])) ? $in['end'] : null), $cx),'
';}),'
';return ob_get_clean();
}
?>