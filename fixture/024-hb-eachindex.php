...
',$cx['funcs']['sec'](((is_array($in) && isset($in['people'])) ? $in['people'] : null), $cx, $in, true, function($cx, $in) {echo '
 <li>',$cx['funcs']['encq']($cx['sp_vars']['index'], $cx),', ',$cx['funcs']['encq']($cx['sp_vars']['key'], $cx),' : ',$cx['funcs']['encq'](((is_array($in) && isset($in['name'])) ? $in['name'] : null), $cx),' ',$cx['funcs']['ifv'](((is_array($in) && isset($in['name'])) ? $in['name'] : null), $cx, $in, function($cx, $in) {echo '(V)';}),'',$cx['funcs']['ifv'](((is_array($cx['scopes'][count($cx['scopes'])-1]) && isset($cx['scopes'][count($cx['scopes'])-1]['test'])) ? $cx['scopes'][count($cx['scopes'])-1]['test'] : null), $cx, $in, function($cx, $in) {echo '(Y)';}),'</li>
';}),'
</ul>
';return ob_get_clean();
}
