...
'funcs' => Array(
    ...
    ob_start();echo '',$cx['funcs']['ifv'](((is_array($in) && isset($in['empty'])) ? $in['empty'] : null), $cx, $in, function($cx, $in) {echo '

';}, function($cx, $in) {echo '
',$cx['funcs']['sec'](((is_array($in) && isset($in['data'])) ? $in['data'] : null), $cx, $in, true, function($cx, $in) {echo '

',$cx['funcs']['sec'](((is_array($in) && isset($in['child'])) ? $in['child'] : null), $cx, $in, true, function($cx, $in) {echo '
    ',$cx['funcs']['ifv'](((is_array($in) && isset($in['key'])) ? $in['key'] : null), $cx, $in, function($cx, $in) {echo '
       The value is = ',$cx['funcs']['encq'](((is_array($in) && isset($in['key'])) ? $in['key'] : null), $cx),' !!
    ';}, function($cx, $in) {echo '
        key is empty or null
    ';}),'

    ',$cx['funcs']['encq'](((is_array($cx['scopes'][count($cx['scopes'])-1]) && isset($cx['scopes'][count($cx['scopes'])-1]['fake'])) ? $cx['scopes'][count($cx['scopes'])-1]['fake'] : null), $cx),'
