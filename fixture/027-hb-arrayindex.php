...
',$cx['funcs']['sec'](((is_array($in) && isset($in['winners'])) ? $in['winners'] : null), $cx, $in, false, function($cx, $in) {echo '
  - EACH 1- ',$cx['funcs']['encq'](((is_array($in) && isset($in['name'])) ? $in['name'] : null), $cx),'
';}),'
end section.

##1 start each:
',$cx['funcs']['sec'](((is_array($in) && isset($in['winners'])) ? $in['winners'] : null), $cx, $in, true, function($cx, $in) {echo '
  - EACH 2 - ',$cx['funcs']['encq'](((is_array($in) && isset($in['name'])) ? $in['name'] : null), $cx),'
';}),'
end each.

##3 Index
Index ?: ',$cx['funcs']['encq'](((is_array($in['winners']) && isset($in['winners']['name'])) ? $in['winners']['name'] : null), $cx),'
Index 0: ',$cx['funcs']['encq'](((is_array($in['winners']['0']) && isset($in['winners']['0']['name'])) ? $in['winners']['0']['name'] : null), $cx),'
Index 1: ',$cx['funcs']['encq'](((is_array($in['winners']['1']) && isset($in['winners']['1']['name'])) ? $in['winners']['1']['name'] : null), $cx),'
';return ob_get_clean();
}
?>