...
. Test 1: ';if ($cx['funcs']['ifvar']('')){echo 'OK';}else{echo '';}echo ' !!
. Test 2: ',$cx['funcs']['encq'](((is_array($in['test']) && isset($in['test']['a b'])) ? $in['test']['a b'] : null), $cx),' !!
. Test 3: ',$cx['funcs']['encq'](((is_array($in['te"st']) && isset($in['te"st']['cd'])) ? $in['te"st']['cd'] : null), $cx),' !!
. Test 4: ';if ($cx['funcs']['ifvar'](((is_array($in) && isset($in['te"st'])) ? $in['te"st'] : null))){echo 'OK';}else{echo '';}echo ' !!
. Test 5: ',$cx['funcs']['ch']('helper1', Array(((is_array($in) && isset($in['url'])) ? $in['url'] : null),'this is a test & OK'), 'raw', $cx),' !!
. Test 6: ',$cx['funcs']['ch']('helper1', Array(((is_array($in) && isset($in['url'])) ? $in['url'] : null),'this is a test'), 'raw', $cx),' !!
. Test 7: ',$cx['funcs']['ch']('helper1', Array(((is_array($in) && isset($in['url'])) ? $in['url'] : null),'this is a test & OK'), 'encq', $cx),' !!
. Test 8: ',$cx['funcs']['ch']('helper1', Array(((is_array($in) && isset($in['url'])) ? $in['url'] : null),'this is a test'), 'encq', $cx),' !!
. Test 9: ',$cx['funcs']['ch']('helper1', Array(((is_array($in) && isset($in['url'])) ? $in['url'] : null),'this.is.atest'), 'encq', $cx),' !!
';return ob_get_clean();
}
?>