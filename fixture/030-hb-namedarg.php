...
. Test 1: ',$cx['funcs']['ch']('helper1', Array(((is_array($in) && isset($in['url'])) ? $in['url'] : null),'this is a test & OK'), 'raw', $cx),' !!
. Test 2: ',$cx['funcs']['ch']('helper1', Array(((is_array($in) && isset($in['url'])) ? $in['url'] : null),'this is a test'), 'raw', $cx),' !!
. Test 3: ',$cx['funcs']['ch']('helper1', Array(((is_array($in) && isset($in['url'])) ? $in['url'] : null),'this is a test & OK'), 'encq', $cx),' !!
. Test 3: ',$cx['funcs']['ch']('helper1', Array(((is_array($in) && isset($in['url'])) ? $in['url'] : null),'string/arg.css'), 'encq', $cx),' !!
. Test 4: ',$cx['funcs']['ch']('helper1', Array(((is_array($in) && isset($in['url'])) ? $in['url'] : null),'this is a test'), 'encq', $cx),' !!
. Test 5: ',$cx['funcs']['ch']('helper2', Array('url'=>((is_array($in) && isset($in['url'])) ? $in['url'] : null),'text'=>'this is a test'), 'encq', $cx, true),' !!
. Test 6: ',$cx['funcs']['ch']('helper2', Array('ur"l'=>((is_array($in) && isset($in['url'])) ? $in['url'] : null),'text'=>'this is a test'), 'encq', $cx, true),' !!
. Test 7: ',$cx['funcs']['ch']('helper2', Array('url'=>'0','text'=>'10'), 'encq', $cx, true),' !!
. Test 8: ',$cx['funcs']['ch']('helper2', Array('url'=>'-1','text'=>'1.3'), 'encq', $cx, true),' !!
';return ob_get_clean();
}
?>