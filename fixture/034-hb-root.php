...
'funcs' => Array(
    ...
    ob_start();echo '<ul class="items">
	',$cx['funcs']['sec'](((is_array($in) && isset($in['items'])) ? $in['items'] : null), $cx, $in, true, function($cx, $in) {echo '
		<li>',$cx['funcs']['encq']($in, $cx),' for ',$cx['funcs']['encq'](((is_array($cx['scopes'][0]) && isset($cx['scopes'][0]['user'])) ? $cx['scopes'][0]['user'] : null), $cx),'</li>
	';}),'
</ul>
';return ob_get_clean();
}
