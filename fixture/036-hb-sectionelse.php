...
'.LR::sec($cx, LR::v($cx, $in, isset($in) ? $in : null, array('child')), null, $in, false, function($cx, $in) {return ''.((LR::ifvar($cx, LR::v($cx, $in, isset($in) ? $in : null, array('key')), false)) ? '       The value is = '.LR::encq($cx, LR::v($cx, $in, isset($in) ? $in : null, array('key'))).' !!
