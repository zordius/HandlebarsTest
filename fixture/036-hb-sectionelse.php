...
'funcs' => Array(
    ...
    ob_start();echo '
Children for ',$cx['funcs']['encq'](((is_array($in) && isset($in['name'])) ? $in['name'] : null), $cx),':

',$cx['funcs']['sec'](((is_array($in) && isset($in['child'])) ? $in['child'] : null), $cx, $in, false, function($cx, $in) {echo '
    ...
    ';}),'
';}, function($cx, $in) {echo '
  ',$cx['funcs']['encq'](((is_array($cx['scopes'][count($cx['scopes'])-1]) && isset($cx['scopes'][count($cx['scopes'])-1]['name'])) ? $cx['scopes'][count($cx['scopes'])-1]['name'] : null), $cx),' has no children.
';}),'
';return ob_get_clean();
}
?>