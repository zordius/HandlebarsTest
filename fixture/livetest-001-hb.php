...
'funcs' => Array(
    ...
    <table>
        ...
        <tr>
            ...
            <h4><a name="',$cx['funcs']['encq'](((is_array($in) && isset($in['name'])) ? $in['name'] : null), $cx),'"></a>問題 $p</h4>
            ',$cx['funcs']['encq'](((is_array($in) && isset($in['yid'])) ? $in['yid'] : null), $cx),' 暱稱：',$cx['funcs']['encq'](((is_array($in) && isset($in['userName'])) ? $in['userName'] : null), $cx),' ( ',$cx['funcs']['encq'](((is_array($in) && isset($in['recommend'])) ? $in['recommend'] : null), $cx),' )<p>',$cx['funcs']['encq'](((is_array($in) && isset($in['comment'])) ? $in['comment'] : null), $cx),'</p>
            </td>
            <td class="asktime">$askTime</td>
        </tr>                               
            ',$cx['funcs']['sec'](((is_array($in) && isset($in['replyer'])) ? $in['replyer'] : null), $cx, $in, true, function($cx, $in) {echo '
                <tr class="gray">
                    <td class="first" colspan="2">
                        ...
                        <p>Lady您好：',$cx['funcs']['encq'](((is_array($in) && isset($in['comment'])) ? $in['comment'] : null), $cx),'</p>
                    </td>
                    <td class="asktime">',$cx['funcs']['encq'](((is_array($in) && isset($in['replyTime'])) ? $in['replyTime'] : null), $cx),'</td>
                </tr>
            ';}),'
        ';}),'
    </table>
